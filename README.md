# Funcatehq Go Library

[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=https%3A%2F%2Fgithub.com%2Flawrencexu%2Ffuncate-server-go-sdk)

The Funcatehq Go library provides convenient access to the Funcatehq APIs from Go.
...
```go
response, err := client.Sessions.CreateSession(...)
if err != nil {
...
```go
response, err := client.Sessions.WithRawResponse.CreateSession(...)
if err != nil {
    return err
}
...
response, err := client.Sessions.CreateSession(ctx, ...)
```
...
response, err := client.Sessions.CreateSession(ctx, request, ...)
```
